...
public class Constants {
  ...
  public static User user = new User(1, "Alaa Kurdi", "alaakurdi@deemalab.com", "1234", "Android", "Android Developer", "Intern", "1-2-1997", "MET", "GUC", "https://image.ibb.co/mYOosp/myimage.jpg", Vacation_days, Sick_leaves, WorkFromHome);


  public static User user1 = new User(2, "Ali Waleed", "aluwilliams@deemalab.com", "1234", "Frontend", "Frontend Developer", "Part-time", "26-1-1997", "MET", "GUC", "", Vacation_days, Sick_leaves, WorkFromHome);

  public static User user2 = new User(3, "Ahmed kamal", "dodo@deemalab.com", "1234", "Frontend", "Frontend Developer", "Part-time", "26-1-1997", "MET", "GUC", "", Vacation_days, Sick_leaves, WorkFromHome);
  public static User user3 = new User(4, "Mohab Amr", "moha@deemalab.com", "1234", "Frontend", "Frontend Developer", "Part-time", "26-1-1997", "MET", "GUC", "", Vacation_days, Sick_leaves, WorkFromHome);
